...
public interface TagMessageWriterBehavior {
	...
	/**
	 * Implementations should override this method to customize how translated messages are rendered on
	 * JSP pages via {@link OpenmrsMessageTag}. They may enclose passed in resolvedText with HTML span
	 * tags, for example.
	 * 
	 ...
	 * @param fallbackText the fallback text provided by tag if given code is not specified or can not
	 *            be resolved
